...
{
    public class StreamCloudEventProcessor
    {
        ...
        protected StreamCloudEventProcessorCheckpointStore CheckpointStore { get; }

        protected StreamCloudEventProcessor(StreamCloudEventProcessorCheckpointStore checkpointStore, string fullyQualifiedNamespace, string topicName, string subscriptionName, string identifier, StreamCloudEventProcessorOptions options) { }

        protected StreamCloudEventProcessor() { }
